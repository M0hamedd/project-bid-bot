...
- Agent-friendly local package resume: `scripts/run_bid_pipeline.py --package-file OPPORTUNITY_ID=PDF_PATH` converts a downloaded official package into a bounded `/api/documents/analyze` completed action before rerunning the pipeline.
