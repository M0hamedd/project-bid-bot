...
class ContractRadarHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        ...
        routes = {
            ...
            "/api/agent/workdir-export": service.export_agent_workdir,
            ...
            "/api/owner-approval/approve": service.approve_owner_request,
            ...
            "/api/pricing/line-item-rate": service.record_pricing_line_item_rate,
            ...
            "/api/demo/golden": service.run_golden_demo,
        }
